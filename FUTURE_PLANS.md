...
- **Spam Quarantining**: Provides an interface to review, delete, release, whitelist, or blacklist quarantined emails in the SQL database.
- **Custom Ban Rules**: Set granular ban policies globally, per-domain, or per-user.
