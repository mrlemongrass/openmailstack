...
- 🟡 Reach personal parity with advanced limits, overrides, private/single-use links, seats, recurring bookings, meeting polls, embeds, and migration/import. Phase 2 now includes the complete private-link slice plus deployed required/optional short, long, and dropdown booking questions with immutable answer snapshots. Optional host confirmation is the next bounded personal-scheduling slice.
