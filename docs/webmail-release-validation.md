...
- Remaining gate: close and reopen iOS Mail, open an Exchange message, and confirm its body renders. This physical result cannot be inferred from scripted WBXML alone.
