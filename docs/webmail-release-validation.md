...
Production rollout decision: the earlier guarded timezone test release remains live; broad completion remains on hold. The exception/reminder/custom-zone implementation has passed local gates and awaits its own rollback-protected deployment plus physical macOS CalDAV/iOS ActiveSync exception-reminder matrix. Do not mark Track T complete from automated conversion evidence alone.
