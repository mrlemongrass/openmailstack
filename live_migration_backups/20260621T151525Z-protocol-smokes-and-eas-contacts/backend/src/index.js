...
app.all(['/Microsoft-Server-ActiveSync'], async (req, res) => {
    ...
    if (cmd === 'FolderSync') {
        ...
        try {
            ...
            folderDescriptors.push({ serverId: "mock-contacts", displayName: "Contacts", type: "9" }, { serverId: "mock-tasks", displayName: "Reminders", type: "7" }, { serverId: "mock-notes", displayName: "Notes", type: "10" });
            try {
