...
function getTagName(page, token) {
    const tag = token & 0x3F;
    if (exports.CODEPAGES[page] && exports.CODEPAGES[page][tag]) {
        return exports.CODEPAGES[page][tag];
    }
    return `UnknownTag_Page${page}_0x${tag.toString(16)}`;
}
//# sourceMappingURL=codepages.js.map