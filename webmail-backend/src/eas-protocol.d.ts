...
export declare const ACTIVE_SYNC_UNSUPPORTED_COMMANDS: readonly ["FolderCreate", "FolderDelete", "FolderUpdate", "GetItemEstimate", "MoveItems", "Provision", "SmartForward", "SmartReply"];
