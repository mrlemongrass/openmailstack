...
export const SCHEDULER_BOOKING_STATUSES = [
    'requested',
    'confirmed',
    'rejected',
    'cancelled',
...
const BOOKING_TRANSITIONS: Readonly<Record<SchedulerBookingStatus, readonly SchedulerBookingStatus[]>> = {
...
export const canTransitionBooking = ({ from, to }: SchedulerBookingTransition): boolean => (
