export declare const SCHEDULER_OUTBOX_EVENT_TYPES: readonly ["booking.requested", "booking.confirmed", "booking.rejected", "booking.cancelled", "booking.rescheduled", "calendar.project", "conference.create", "message.send", "payment.create", "webhook.deliver"];
