...
export interface CalendarEvent {
  ...
  notifications?: { id: number; type: string; time: number }[];
  ...
  seriesNotifications?: { id: number; type: string; time: number }[];
  seriesIsAllDay?: boolean;
  seriesTimeKind?: 'utc' | 'zoned' | 'floating' | 'all-day';
  seriesTimeZone?: string | null;
  seriesSourceTimeZone?: string;
  seriesTimeZoneStatus?: 'valid' | 'canonicalized' | 'unsupported' | 'invalid';
  rawIcal?: string;
  guests?: string[];
